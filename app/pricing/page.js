    ...
    return (
        <div className="bg-[#E2E1DC] inter">
            ...
            <h1 className={`font-archivo font-bold leading-none transition-colors duration-300 text-3xl xs:text-3xl sm:text-4xl md:text-4xl lg:text-5xl ${isDark ? "text-white" : "text-black"}`}>Pricing</h1>
                    ...
                    isDark
                        ...
                        >
                            <div className="text-xs md:text-sm lg:text-base">
                                <h1
                                    className={`text-xl md:text-2xl lg:text-3xl leading-none font-bold transition-colors duration-300 ${
                            ...
                            <div className="flex gap-2 md:gap-2 lg:gap-2.5 absolute top-1/2 -translate-y-1/2 flex-wrap">
                                <h3
                                    className={`py-1.5 px-2.5 md:py-1.5 md:px-2.5 lg:py-2 lg:px-3 rounded-full leading-none text-[9px] md:text-[10px] lg:text-xs transition-colors duration-300 ${
                                        isDark
                            ...
                            <div className="flex justify-between items-center">
                                <h1
                                    className={`font-light text-xs md:text-sm lg:text-base transition-colors duration-300 ${
                                ...
                                <button className="px-3 py-1.5 md:px-3 md:py-1.5 lg:px-3.5 lg:py-2 bg-[#FF6B3A] text-[10px] md:text-xs lg:text-sm rounded-full text-white cursor-pointer leading-tight hover:bg-[#FF5520] transition-colors">
                                    START NOW
                                </button>
                            </div>
                        </div>
                        ...
                        >
                            <div className="text-xs md:text-sm lg:text-base">
                                <div className="flex items-center justify-between">
                                    <h1 className="text-xl md:text-2xl lg:text-3xl leading-none font-bold text-white">
                                        Growth
                                    </h1>
                                    <div className="flex items-center gap-1 font-bold text-[9px] md:text-[10px] lg:text-xs">
                                        <Image
                            ...
                            <div className="flex gap-2 md:gap-2 lg:gap-2.5 absolute top-1/2 -translate-y-1/2 flex-wrap">
                                <h3 className="py-1.5 px-2.5 md:py-1.5 md:px-2.5 lg:py-2 lg:px-3 bg-white text-black rounded-full leading-none text-[9px] md:text-[10px] lg:text-xs">
                                    1500 Credits
                                </h3>
                                <h3 className="py-1.5 px-2.5 md:py-1.5 md:px-2.5 lg:py-2 lg:px-3 bg-white text-black rounded-full leading-none text-[9px] md:text-[10px] lg:text-xs">
                            ...
                            <div className="flex justify-between items-center">
                                <h1 className="font-light text-white text-xs md:text-sm lg:text-base">
                                    <span className="text-xl md:text-2xl lg:text-3xl font-bold text-white">$149</span>
                                    /Month
                                </h1>
                                <button
                                    className={`px-3 py-1.5 md:px-3 md:py-1.5 lg:px-3.5 lg:py-2 text-[10px] md:text-xs lg:text-sm rounded-full cursor-pointer leading-tight transition-colors ${
                                        isDark
                    ...
                    isDark
                        ...
                        >
                            ...
                            <div className="flex gap-2 md:gap-2 lg:gap-2.5 absolute top-1/2 -translate-y-1/2 flex-wrap">
                                ...
                                <h3
                                    className={`py-1.5 px-2.5 md:py-1.5 md:px-2.5 lg:py-2 lg:px-3 rounded-full leading-none text-[9px] md:text-[10px] lg:text-xs whitespace-nowrap transition-colors duration-300 ${
                                        isDark
                                            ? "border border-gray-600 text-gray-300"
                                            : "border border-[#828282] text-black"
                                    }`}
                            ...
                            <div className="flex justify-between items-center">
                                <h1 className="font-bold text-lg md:text-xl lg:text-2xl bg-gradient-to-r from-[#FFB347] via-[#FF6B3A] to-[#DD3305] bg-clip-text text-transparent">
                                    Custom
                                </h1>
                ...
                <div
                    className={`mt-4 md:mt-4 lg:mt-5 flex gap-2 md:gap-2 lg:gap-2.5 self-end items-center text-xs md:text-sm lg:text-base font-light px-4 md:px-[2.5%] flex-wrap transition-colors duration-300 ${
                        isDark ? "text-gray-300" : "text-black"
                    }`}
                >
                    <h3>ADD-ONS</h3>
                    ...
                    >
                        Extra credits :{" "}
                        <span className="text-base md:text-lg lg:text-xl font-medium leading-none">
                            $0.15
                        </span>
