  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.from(
        ...
        .from(
          ".img1",
          { left: "-15vw", top: "-5vh", duration: 2, ease: "power2.inOut" },
          0
        )
        .from(
          ".img2",
          { left: "-5vw", bottom: "-5vh", duration: 2, ease: "power2.inOut" },
          0
        )
        .from(
          ".img3",
          { bottom: "-50vh", left: "-10vw", duration: 2, ease: "power2.inOut" },
          0
        )
        .from(
          ".img4",
          { right: "-5vw", bottom: "-5vh", duration: 2, ease: "power2.inOut" },
          0
        )
        .from(
          ".img5",
        ...
        .from(
          ".img6",
          { right: "-12vw", top: "-5vh", duration: 2, ease: "expo.inOut" },
          0
        )
        .from(
          ".img7",
          { right: "-20vw", top: "-10vh", duration: 2, ease: "power2.inOut" },
          0
        )
        .from(
          ".img8",
          { left: "-5vw", top: "-2vh", duration: 2, ease: "power2.inOut" },
          0
        )
        .fromTo(
          ".content-text",
      ...
      tl.to(
        ...
        .to(
          ".img1",
          { left: "-20vw", top: "-5vh", duration: 2.5, ease: "power2.inOut" },
          3
        )
        .to(
          ".img2",
          { left: "-5vw", bottom: "-5vh", duration: 2.5, ease: "power2.inOut" },
          3
        )
        .to(
          ".img3",
        ...
        .to(
          ".img6",
          {
            ...
            y: () => {
              ...
              const rect = img6.getBoundingClientRect();
              return (
                window.innerHeight / 2 - rect.top - img6.offsetHeight / 2 + 40
              );
            },
            scale: 2.8,
            duration: 3,
        ...
        .to(
          ".img7",
          { right: "-20vw", top: "-15vh", duration: 2.5, ease: "power2.inOut" },
          3
        )
        .to(
          ".img8",
          { left: "-10vw", top: "-2vh", duration: 2.5, ease: "power2.inOut" },
          3
        )
        .to(
          ".content-text.heading",
          { y: -60, opacity: 0, duration: 2, ease: "power2.inOut" },
          3.5
        )
        .to(
          ".content-text.para",
        ...
        .to(
          ".input-field",
          {
            ...
            x: () => {
              ...
              return (
                window.innerWidth / 2 - rect.left - inputField.offsetWidth / 2
              );
            },
            y: () => {
              const inputField = document.querySelector(".input-field");
              ...
              const rect = inputField.getBoundingClientRect();
              return (
                window.innerHeight / 4 - rect.top - inputField.offsetHeight / 2
              );
            },
            duration: 2,
            ease: "power2.inOut",
      ...
      tl.to(
        heading.words,
        { y: 0, opacity: 1, duration: 2, stagger: 0.25, ease: "power3.inOut" },
        4.2
      )
        .to(
          ".popup",
      ...
      tl.to(
        ...
        .to(
          ".anim3-gradient",
          { y: "-5vh", opacity: 0, duration: 2, ease: "power2.inOut" },
          7
        )
        .to(
          ".input-field",
        ...
        .to(
          ".popup.four",
          { y: "10vh", x: "-20.8vw", duration: 2, ease: "power2.inOut" },
          8
        )
        .to(
          ".img6",
        ...
        .to(
          ".img6 .img-gradient",
          { scale: 1.8, duration: 2, ease: "power2.inOut" },
          8
        )
        .to(
          heading2.words,
        ...
        .from(
          ".chat-logo",
          { scale: 0, opacity: 0, duration: 1.5, ease: "back.out(1.7)" },
          8.2
        )
        .from(
          ".chat-bubble",
      ...
      tl.to(
        ".img6",
        { y: "-100vh", opacity: 0, duration: 2.5, ease: "power2.inOut" },
        10.5
      )
        .to(
          ".anim4-heading",
        ...
        >
          <div className="relative w-[40%] flex flex-col gap-14 -top-14">
            ...
            <p className="text-sm font-[300] text-gray-500 leading-[100%] content-text para z-10">
              Ask FYUZE AI to fetch a real-time, curated list of influencers
              based on your niche, audience, and campaign goals so you save
            ...
            <div className="w-6/12 relative h-[40vh] z-100 flex items-center justify-center flex-col">
              ...
              <div className="absolute popup four right-[4vw] top-[55%] flex items-center justify-center gap-2 p-[10px] min-w-[14vw] rounded-[20px] overflow-hidden popup-gradient">
                ...
                <span className="font-[500] text-[0.9vw] leading-[2vw] text-white">
                  FYUZE Score :
                  <span className="text-[1.3vw] leading-[1.3vw]">90</span>
                  /100
                </span>
              </div>
