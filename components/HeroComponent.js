    ...
    return (
        ...
        >
            ...
            >
                ...
                ></div>
                <div
                    className="absolute w-full h-full flex-center z-100 left-0 top-0 pointer-events-none"
                    style={{ willChange: "opacity, transform" }}
                >
                    <div
                        className="relative flex-center flex-col w-1/2"
                        style={{ willChange: "opacity, transform" }}
                    >
                        <div
                            className="relative w-full flex-center flex-col gap-12"
                            style={{ willChange: "opacity, transform" }}
                        >
                            <div
                                className="flex-center flex-col gap-6 relative"
                                style={{ willChange: "opacity, transform" }}
                            >
                                <h1
                                    className="font-archivo text-[1.8vw] leading-[1.5vw] font-bold hero-fade"
                                    style={{ willChange: "opacity, transform" }}
                                >
                                    Ask Fyuze to find your next Influencer
                                </h1>
                                <p
                                    className="text-sm font-[300] leading-[110%] w-[58%] mx-auto text-center hero-fade"
                                    style={{ willChange: "opacity, transform" }}
                                >
                            ...
                            <div
                                className="relative w-full h-full pointer-events-auto hero-fade"
                                style={{ willChange: "opacity, transform" }}
                            >
                                <input
                                    type="text"
                                ...
                                />
                                <div
                                    className="relative w-full flex-between p-5 h-full input-gradient rounded-[28px] backdrop-blur-[120px] z-80"
                                    style={{
                                        willChange:
                                ...
                                >
                                    <SparkleSvg />
                                    <div
                                        className="flex-center relative gap-3"
                                        style={{
                    ...
                    <div
                        className="absolute bottom-8 flex justify-start items-start w-full pl-10 pointer-events-auto"
                        style={{ willChange: "opacity, transform" }}
                    >
                        <div
                            className="flex-between gap-10 relative"
                            style={{ willChange: "opacity, transform" }}
                        >
                            <Link
                                href="/"
                            ...
                            <div
                                className="relative w-[2px] h-[2px] rounded-full bg-white"
                                style={{ willChange: "opacity, transform" }}
                            ></div>
                            <Link
                                href="/"
                    ...
                    >
                        <div
                            className="w-[0.6px] h-[20px] relative bg-white line1"
                            style={{
                                willChange: "clip-path, opacity, transform",
                            }}
                        ></div>
                        <p
                            className="text-xs text-center font-medium font-archivo leading-[100%] uppercase text"
                            style={{ willChange: "opacity, transform" }}
                        >
                            Scroll to explore
                        </p>
                        <div
                            className="w-[0.6px] h-[5px] relative bg-white line2"
                            style={{
                                willChange: "clip-path, opacity, transform",
                            }}
                        ></div>
